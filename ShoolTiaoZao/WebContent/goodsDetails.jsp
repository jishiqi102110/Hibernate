...
<div class="container">
         <div class="row">
          <div class="col-md-6" style="height: 400px;">
                    <img src=<%=request.getParameter("imageAddress") %> class="img-thumbnail" style="margin-top: 40px;float: right;">
          </div>
             <div class="col-md-6" style="height: 400px;">
                 <table border="0" style="margin-top: 70px;">
                     <tr><td>商品名称：</td><td><%=request.getParameter("goodsName")%></td></tr>
                     <tr><td>价格：</td><td><%=request.getParameter("goodsPrice") %>元</td></tr>
                     <tr><td>使用时间：</td><td>一个月以内</td></tr>
                     <tr><td>发布时期：</td><td><%=request.getParameter("time") %></td></tr>
                     <tr><td>发布人编号：</td><td><%=request.getParameter("userID") %></td></tr>
                 </table>
                 <%
                 String HyperLink=null;
            	 String goodsName=request.getParameter("goodsName");//给购物车传递过去发布人姓名、商品价格、照片地址、商品名称
            	 String goodsPrice=request.getParameter("goodsPrice");
            	 String imageAddress=request.getParameter("imageAddress");
            	 String userID=request.getParameter("userID");
            	 String time=request.getParameter("time");
                 HyperLink="addCart.do?imageAddress="+imageAddress+"&&userID="+userID+"&&goodsPrice="+goodsPrice+"&&goodsName="+goodsName+"&&time="+time;
                 %>
                 <div class="btn btn-lg btn-info" style="margin-top: 40px"><a href=<%=HyperLink%>>加入购物车</a> </div>
         </div>
        </div>
</div>
<div class="footer">
